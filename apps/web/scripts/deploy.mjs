...
scp(join(ROOT, 'apps/server/worker/watchdog.sh'), `${REMOTE_STACK}/worker/watchdog.sh`)
scp(join(ROOT, 'apps/server/adcutforge/src/ad_cut_forge.py'), `${REMOTE_STACK}/adcutforge/src/ad_cut_forge.py`)
ssh(`chmod 755 ${REMOTE_STACK}/worker/run_once.sh ${REMOTE_STACK}/worker/run_daemon.sh ${REMOTE_STACK}/worker/watchdog.sh && chmod 644 ${REMOTE_STACK}/worker/process_jobs.py ${REMOTE_STACK}/adcutforge/src/ad_cut_forge.py`)
